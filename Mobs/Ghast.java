...
public class Ghast extends FlyingMob implements Enemy {
    ...
    public boolean isInvulnerableTo(DamageSource damageSource) {
        return this.isInvulnerable() && !damageSource.is(DamageTypeTags.BYPASSES_INVULNERABILITY) || !Ghast.isReflectedFireball(damageSource) && super.isInvulnerableTo(damageSource);
    }
